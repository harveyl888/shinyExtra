...
#                      SXSortable('sort1', labels = list(list('label1', 'label2', 'label3'), list('label4', 'label5', 'label6'), list('X1', 'X2', 'X3', 'X4')), styleclass = list('success', 'primary', 'warning'), height = 100)
                      SXSortable('sort1',
                                 labels = list(list("label 1", "label 2", "label 3"), list("label 4", "label 5")),
                                 styleclass = list("success", "primary"),
                                 headers = list("Header for first group", "Header for second group"),
                                 width = 150,
                                 height = 100)
                      ))
  ),
